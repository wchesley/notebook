<# 
.SYNOPSIS
    Detect all unquoted service paths in Windows services.

.DESCRIPTION
    This script checks all Windows services for unquoted service paths and exits with error code 1 if any are discovered. 
    This script is designed to run as a Microsoft Intune detection script. See the accompanying remediate.ps1 script for remediation.
...
.OUTPUTS
    Exit 0: No unquoted service paths detected.
    Exit 1: Unquoted service paths detected.

.EXAMPLE
    detect.ps1
    Scans and detects unquoted service paths in Windows services.
...
$badSvc = Get-WmiObject win32_service | Where-Object { $_.PathName -notmatch "`"" -and $_.PathName -notmatch "C:\\Windows" -and $_.PathName -ne [string]::IsNullOrEmpty($_.PathName) } | Select-Object Name, PathName

if ($badSvc.Count -gt 0) {
    Write-Host "Unquoted service paths detected:"
    $badSvc | ForEach-Object { Write-Host "Service Name: $($_.Name), Path: $($_.PathName)" }
    exit 1
}
else {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBe2ANK/pP/AweU
# bk/PxkbA2nTJlcXgDrSKOBbxVewYzqCCF94wggSgMIIDiKADAgECAhNCAAAAR1OX
...
# AYI3AgEVMC8GCSqGSIb3DQEJBDEiBCARmezbVlKksY5Qv5UzD7qmp+CsvSPgQodM
# +WklA9LM5zANBgkqhkiG9w0BAQEFAASCAQDm2L6P6pzo5DvyaE/t3jZENKJAMHYc
# 9gcMrWavyY9g+y2W6ow8DnSEdEA3aq1lE8bU20M9xjpH4VtuwxPasBklFsgwZKXv
# F7YGypGCTpHH3dPgRP/nyQKPTmA6can6/kf69EwRDxsSzvHl2x0LOL3h/6DXnnmQ
# 16qJw5mzb9o9b1UiiygysXBGZe2tyRrotLhgwWDIku9O/Fuv1E/loLDnkQEYy7NP
# e+vrKHrznpnIw+iRZtx7+To6VvuUM4Yihp++bgeNl05PXHJn2PO08/nmSFKDwtIw
# HvohucNu5c6gId9u1aWN9/Qr7cIZMLiw6gUfVaew4pMvo5PzjhN3qlw2oYIDJjCC
...
# BwEwHAYJKoZIhvcNAQkFMQ8XDTI1MDkyNDEzMDQ1MlowLwYJKoZIhvcNAQkEMSIE
# IKeVB/Yb9QDONa9x4r9r4FMylToM48yiNBq3pbA/YCAJMA0GCSqGSIb3DQEBAQUA
# BIICAJQa2QOPNq1NjkM/cME7NHi4dM8uczekLVCcbcyeyQKvBwjknz1TfeI7edh+
# QlGlHrEl4g8OG/R1Shb5ldbzNEh/cdvP5QXpmwM3zCM7E8fb7gFdSnJsRr0rJj8P
# yObGXy7xXG2CAio1lQwc02j3ABMXS0uk/WNdigNOV4fFj2Y8LF3AT5JhoblGLU7X
# SoBMktwclZhTdmRHxzIQQfeToCqml2SOeUPk1qvn0wc6pMD077PCHj20H1p5Yh5X
# P1HEsrR3foCm+2nKUl+uHWASDtw4Wd0kcYjxckjjQV0ouzi8VSiPNBmbKDi56lim
# 5w9jnL6R0kfsIP+VVZz3DKq4M2Ghz2sN41IUHLzeacqehYGxxPJZlOv7H9mT5CJ1
# XmpsLpeM7siTQQ/JW+u3Ov3NHm6mmqX7d097LvYVMp5Kxlg7lN7z6rfUDnHYiufB
# fVyUPZvvA6rpebxMzmJ7B6S1rRdiZf433aic6/ys2pfOn6v8GjLiZ4QKm1l53S2s
# vE0u6Alqlg0lgAvqv3LxMG/b5yrkZrkaVJIg3WIjl4IVKBXozUGdEoUfUirD1Plp
# rYzO6NvRUEpGK/r5bJ53kXYl6pgiWCBjQkH0VF6KxcdG60GE0zlkRfEPcxBFcnzP
# 7khd3VWnyzWfRv3AugBHwUEyg478ABhP1Ptoqc6kNcrwuiGb
