function Convert-DisplayNameToLDAPFilter {
    <#
    .SYNOPSIS
        Converts a display name into an LDAP filter string for searching in Active Directory.
    .DESCRIPTION
        This function takes a display name, splits it into individual components, and constructs an LDAP filter string that can be used to search for users in Active Directory.
        Each component of the display name is used to create a wildcard search clause, allowing for flexible matching.
    .PARAMETER DisplayName
        The display name to convert into an LDAP filter. This can include multiple parts (e.g., first name, last name).
    .EXAMPLE
        $filter = Convert-DisplayNameToLDAPFilter -DisplayName "John Doe"
        This command will return the LDAP filter string "(DisplayName -like '*John*') -and (DisplayName -like '*Doe*')".
    .NOTES
    ...
    #>
    param (
        [Parameter(Mandatory = $true, HelpMessage = "The display name to convert into an LDAP filter.")]
        [ValidateNotNullOrEmpty()]
        [string]$DisplayName
    )

    $nameParts = $DisplayName.Split(' ', [System.StringSplitOptions]::RemoveEmptyEntries)
    $filterClauses = $nameParts | ForEach-Object { "(DisplayName -like '*$_*')" }
    $ldapFilter = $filterClauses -join ' -and '

    return $ldapFilter
}

Export-ModuleMember -Function Convert-DisplayNameToLDAPFilter
# SIG # Begin signature block
# MIIhQQYJKoZIhvcNAQcCoIIhMjCCIS4CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBBXqCJ+ZvBDTbj
# m3Q9iyju/CUHWjS/zu1dDkFmT9rhJqCCG18wggN9MIICZaADAgECAhAYr67jz8w+
...
# DQEJBDEiBCCFS9h9uL+B3pXpRRsVTbcufJXgjbQAgushEz7YylEE9DANBgkqhkiG
# 9w0BAQEFAASCAQDZ+BkcMcrhjCvmskOu0rNA85xHf3XZgw7pRD4PoGJt4dQdUvSU
# FYcs+Kbebwd6BkKGxwLXAo09evKJZKQmgtMMC1SlILb3oHY5+ttIBLcsnf202gAz
# g94exJ80FyFK4oHZhtx8Tl8lm7e+ZJEbh5D+6seR5OyUAX9FYtj086o0UCul/z1j
# ccQPkDmUI9oyPK7RMxtLsbEvGa3Q4jljdnFyIUn99qynhdD5XBEP4QdBesWlJbPp
# Yky9/q2pOdZaeW/F3z2J9ANk1fAWB71dmEmb0BKBE+L4lT9IxAMWlDhRO3uOTl8P
# 2UA0I4dJZ9p4LCZa+Xigsn6Ux20f5lV6e/nmoYIDJjCCAyIGCSqGSIb3DQEJBjGC
...
# MQ8XDTI1MTAwMTE0MzMxMFowLwYJKoZIhvcNAQkEMSIEIJa+D0LOuu/LbPBMs7//
# 0zrSOp976XT6MeJxg37npMS9MA0GCSqGSIb3DQEBAQUABIICAGQhEmj2PnHmwll9
# xABQz3luOaSXHOaz0+Mdp90NjCf2eL45A5W7nQHf65ft5+vrUdrkz/EdVuXvn49Q
# JdeF6EDWoppEUXJKEMBDUy3zkzpbV2BUMa8BMTRKBY7SHNks6QKvXzM+NLuoDWfm
# d6/m+YMkDeaT1PoH+AYqQ3YZW56RJlYxCG4AlC175PJRLiZ94ZiRF6KkbkHnluhK
# UedNwaoPTa83y/h5J9qxONsuTgw6ZFeTZ0mkcepVmi9v/DA/6cJqqajJ/GPpldzB
# V7qsyG4jGGPPL5fJIjFPTKocphf9IBxJZtoYZEODfFJ8PUrllsLeGgkWyaxiYvUV
# 9Mkp6//gBwNZg+wrCoj+B5WxabQmFbugayf3AeQmYodDDnFwDvVnNRweA3psQd3r
# aLGd4+UwlQn0qL0wXxCfuWBUZiRlGQDaOy6NRfVC+dhG6ld23FNbi8qrJ20k0dqH
# fvQYw4PVFY50R3JJpFI92J7rdgjRW6GYj5B3sO2ITxWwsiE9wEA2QElSmPBjIkON
# B9QwZ3Wv1y/JaO6zUxlhXQ3ZgtSWHu4kypXGWQlVOQpRQOHeI65C4jzk6pUdDqk6
# e4LQswg3M/DPbXpNRxPcw23ikOPQPxWBhEIF+nBrEg0QjkTiMv/k4J6gnQjlbmTN
# i6De4tiTVU+WR14gI3DHe2mW6tiK
