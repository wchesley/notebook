...
veeamInfluxDBURL="http://172.16.0.62" #Your InfluxDB Server, http://FQDN or https://FQDN if using SSL
veeamInfluxDBPort="8086" #Default Port
veeamInfluxDBBucket="WGDC-Veeam" # InfluxDB bucket name (not ID)
veeamInfluxDBToken="hAECQwGJSBvaFJ588EiqoxK-ORgCprGSe2K_r3Md2_V_wvMbIaluozN-XnMr32DNn1LO2_HP_Fmps2PIT_11CA==" # InfluxDB access token with read/write privileges for the bucket
veeamInfluxDBOrg="WGDC" # InfluxDB organisation name (not ID)
...
# Alternatively: use a VSPC API key: 
...
veeamRestServer="https://172.16.0.56"
veeamRestPort="1280/api/v3" #Default Port
